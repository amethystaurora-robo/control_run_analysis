...
Below, a time series is shown with a transient period prior to reaching the attractor: the subset of phase space where trajectories settle.
...
A control run is initialized after spinning up the model for 1000 years. The timeseries from Years 1001-2000 is shown below.
...
<p>
  <img src="https://github.com/amethystaurora-robo/control_run_analysis/blob/main/control_hist.png">
</p>
